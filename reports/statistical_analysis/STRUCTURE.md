...
#### `diagnostics/`
**Source**: `01_data_validation_extraction.py`, `02_book_aggregation.py`
...
This includes:
- `taxonomy_radway_eda/` (archived - topic lookup and metadata now integrated into book_features)
...
# Run validation (saves to diagnostics/)
