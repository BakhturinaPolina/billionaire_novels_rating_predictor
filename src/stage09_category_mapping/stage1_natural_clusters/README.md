...
- ✅ Processing time: ~1 hour 39 minutes (inference only)
- ✅ Assigned 369 unique topics (368 non-outlier + 1 outlier)
- ✅ Outlier sentences: 8,051 (1.31% of sentences)
- ✅ Output file size: 1,312.94 MB (includes probability distributions)
- ✅ Top topics: Topic 8 (3.15%), Topic 7 (2.89%), Topic 1 (2.00%)
...
1. Load the matched-only dataframe with topic assignments from Step 3:
   ...
   docs = df["text"].tolist()
   # Uses only matched sentences (92 books, ~612k sentences)
   ```
