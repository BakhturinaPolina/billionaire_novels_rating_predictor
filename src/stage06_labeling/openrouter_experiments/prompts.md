...
| Aspect | Version 1 (Universal) | Version 2 (6-Component) |
|--------|----------------------|------------------------|
| **Output Format** | Single short label (2-6 words) | 6 tab-separated components |
| **Complexity** | Simple, concise | Detailed, structured |
| **Use Case** | Quick topic identification | Comprehensive topic analysis |
| **Domain Adaptation** | Uses adaptive hints | Fixed structure |
| **Current Usage** | `generate_labels.py` (local LLM) | Notebook experiments (OpenRouter) |
| **Integration** | Direct label string | Requires parsing tab-separated values |
...
- Both versions can be adapted for use with OpenRouter API or local LLMs
- The choice between versions depends on the desired level of detail in topic labels
